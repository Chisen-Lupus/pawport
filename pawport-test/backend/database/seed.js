  ...
  try {
    ...
    const cons = await Con.bulkCreate([
      ...
      },
      {
        ...
        theme: '永恒测试',
        theme_color: '#FF5252',
        description: '这是一个当前进行中的测试兽展，用于验证当前展览的显示效果',
        status: 'approved',
        is_test: true,
      },
      {
      ...
      {
        name: '极兽聚 秋季2026',
        name_en: 'Polarfur Autumn 2026',
        name_local: '极兽聚',
        series_key: 'polarfur',
        series_name: '极兽聚 Polarfur',
        edition_label: '2026 秋',
    ...
    await UserConHotel.bulkCreate([
      { user_con_id: userCons[0].id, hotel_id: hotels[0].id, check_in: '2026-03-12', check_out: '2026-03-16' },
      { user_con_id: userCons[1].id, hotel_id: hotels[1].id, check_in: '2026-04-16', check_out: '2026-04-20' },
      { user_con_id: userCons[2].id, hotel_id: hotels[4].id, check_in: '2026-07-01', check_out: '2026-07-06' },
      { user_con_id: userCons[4].id, hotel_id: hotels[2].id, check_in: '2026-05-21', check_out: '2026-05-26' },
      { user_con_id: userCons[5].id, hotel_id: hotels[3].id, check_in: '2026-06-04', check_out: '2026-06-08' },
      { user_con_id: userCons[6].id, hotel_id: hotels[5].id, check_in: '2026-07-01', check_out: '2026-07-06' },
      { user_con_id: userCons[8].id, hotel_id: hotels[6].id, check_in: '2026-07-01', check_out: '2026-07-06' },
